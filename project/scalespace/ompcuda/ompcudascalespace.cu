...
int main(int argc, char** argv) {
	...
	//initialize timing variables for openmp timing
	...
	//start timer call omp, start loop
	...
	t = iter*1.0;
        	...
        	// Loop over image pixels by calling kernel
		...
		//save image!
    		char filename[64];
   	 	sprintf (filename, "../../images/Ompcudascalespace/ompcuda%i.jpg", iter);
